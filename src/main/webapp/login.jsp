    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="whysignLogin">
          <h1>${msg}</h1>
          <h2>Royal Vehicle Rental</h2>
          <p>Unlock the freedom to explore with our hassle-free vehicle rental service offering a wide range of cars for every journey, whether it's a quick city errand or a cross-country adventure. Affordable, reliable, and always ready when you are!</p>
        </div>
      </div>
    </div>
  </div>
